...
var FireworkData = [
    ...
    { size: 0.6, position: { x: 50, y: 50 }, height: 0, duration: 5, color: '#ffff00', label: 'B firework' },
    { size: 0.8, position: { x: 80, y: 100 }, height: 0, duration: 4, color: '#00ffff', label: 'C firework' },
];